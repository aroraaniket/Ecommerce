...
import {listwomenproducts, saveProduct} from '../actions/Product'
import Spinner from '../component/layout/Spinner';
function LinkWomenScreen(props) { 
  ...
  const isMounted = useRef(true);
    ...
    const productList = useSelector((state) => state.productListWomen);
...
export default LinkWomenScreen
