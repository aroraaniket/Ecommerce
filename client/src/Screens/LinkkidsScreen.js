...
import { listkidsproducts, saveProduct} from '../actions/Product'

function LinkkidsScreen(props) {
  ...
  const isMounted = useRef(true);
    ...
    const productList = useSelector((state) => state.productListKids);
