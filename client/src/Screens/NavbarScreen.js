...
const clickHandler=()=>{
 setToggle(prev=>!prev)
  ...
  return ( 
    <div className="navbar-div">
      ...
      <Link to='/'>
         ...
         <img src="https://www.onlinelogomaker.com/blog/wp-content/uploads/2017/06/shopping-online.jpg" alt="logo" /> 
         </Link>
      ...
      <div  className="nav-div">
        <div className="header-ul">
            ...
            <Link className="hovereffect" to="/shop/men">men</Link>
          </div>

          <div className="header-ul">
         
            <Link className="hovereffect" to="/shop/women">Women</Link>
          </div>

          <div className="header-ul">
         
            <Link className="hovereffect" to="/shop/kids">kids</Link>
          </div>
  ...
  <input placeholder="Search for products, brands and more" className="desktop-searchBar" 
  value={Input} onChange={(e)=>setInput(e.target.value)} 
  onKeyPress={handleKeypress}
  onKeyUp={handleKeypress}
  />

  <FontAwesomeIcon className="fa fa-search desktop-submit" icon='search' viewBox="0 0 820 820"  />
...
<div id="header-menu-icon">
    <div  onClick={(e)=>clickHandler(e.target.value)}   className="header-icon menu-icon" >
    
      <svg   viewBox="0 0 20 20" >
        <path d="M3.444 5.422a.733.733 0 110-1.466h17.047a.733.733 0 110 1.466H3.444zm0 7.111a.733.733 0 110-1.466h17.047a.733.733 0 110 1.466H3.444zm0 7.111a.733.733 0 110-1.466h17.047a.733.733 0 110 1.466H3.444z" fill="#3E4152" fillRule="evenodd">
      </path>
   ...
   <div className="mobile-div">
        <div className="mobile-div-link" >
            ...
            <Link  to="/search">
            <FontAwesomeIcon className="fa fa-search " icon='search' viewBox="0 0 820 820"  />
      ...
      <div className="desktop-userActionsContent" >
        {user ?
        <Link to="/profile"  className="desktop-getUserInLinks desktop-getInLinks" style={{
          color:" #282c3f", textDecoration:"none" , 
        }} > Hello  <span style={{fontWeight:"500"}}> {  user.name} </span> </Link>
...
{!user &&
       <Link  className="desktop-linkButton" to='/signin'>
        login / Signup
          ...
          <div className="desktop-getInLinks">
            ...
            <a href="/my/orders" data-track="coupons" className="desktop-info">
            <div className="desktop-infoSection">Orders</div>
          </a>
          <a href="/wishlist" data-track="coupons" className="desktop-info">
            <div className="desktop-infoSection">Wishlist</div>
          </a>
      
            <a href="/contactus" data-track="coupons" className="desktop-info">
              <div className="desktop-infoSection">Contact Us</div>
            </a>
           </div>
           <div className="desktop-getInLinks">
          <a href="/my/savedcards" data-track="coupons" className="desktop-info">
            <div className="desktop-infoSection">Saved Cards</div>
          </a>
            <a href="/my/address" data-track="coupons" className="desktop-info">
              <div className="desktop-infoSection">Saved Addresses</div>
            </a>
          </div>
          <div className="desktop-getInLinks">
          {user && (
            <a  className="desktop-info" href='/' onClick={() => Logout()}>
        ...
        */}
        ...
        <div  style={{left:"12px" ,bottom:"70px"}} className=" fa-2x user-icon icon-profile">
